...
>
> **适用范围**：段落格式和对话格式适用于所有体裁。小节(beat)结构和字数标准仅适用于短篇。长篇小说字数以当前 skill 的字数硬约束为准。
...
连续的短段落（1-2 句）制造紧张感。偶尔用 3 句的段落作为呼吸点。不要为了卡字数硬拆，优先保证剧情顺滑、镜头清楚。
...
1. **避免大段堆砌**：一段不要同时塞多个动作、信息和情绪转折；影响阅读时按镜头或信息变化拆分
