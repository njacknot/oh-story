...
只给主角、关键关系人、反派填写；普通配角不填。用途是在高压冲突里让人物反应符合人设，避免所有角色都手抖、沉默、冷笑。

### 填空模板

```md
### 压力反应：{角色名}
- 压力触发：{最怕被羞辱/抛弃/误解/失控/失去某人/暴露秘密}
- 默认反应：{压住/反击/逃走/讨好/装冷静/转移话题}
- 身体信号：{最先出现的具体动作，如整理袖口、摸旧疤、确认门锁}
...
- 压力反应必须和角色弱点、动机链有关；不能只写通用身体反应。
- 同一角色的压力反应要能反复出现并升级：轻压只露身体信号，重压触发语言变化，极压越过失控边界。
- 高压场景写作前先看这张卡，用它决定角色动作和台词，不要用旁白解释“他很紧张/她很害怕”。
